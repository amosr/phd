...
\subsubsection{Flat data parallelism}
...
\subsubsection{Nested data parallelism}
...
\paragraph{Data Parallel Haskell}
...
\subsubsection{Feedback directed automatic parallelism}
