...
splitPoints b particles 
  = (boxes, splitPars) -- unzipP [: (b,p) | (b,p) <- zipP boxes splitPars, lengthP p I.> 0:]
  where boxes           = singletonP b  +:+ singletonP b  -- +:+ singletonP b +:+ singletonP b
        splitPars       = singletonP particles +:+ singletonP particles -- +:+ singletonP particles +:+ singletonP particles
